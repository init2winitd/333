...
func (r *Registry) Create(label, serverID, workspace string) (*Session, error) {
	...
	tools := map[string]bool{"read_file": true, "list_dir": true, "write_file": true, "edit_file": true, "search_text": true, "shell": true, "remember": true, "recall": true, "fetch_url": true, "find_files": true, "run_script": true}
